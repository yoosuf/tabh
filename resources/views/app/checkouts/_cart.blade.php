    ...
    <div class="card-content">
        ...
        <div class="media item-description" style="">
            <div class="media-content">
                <div class="content">
                    <p>{{$item['item']->name}} | &#2547; {{number_format(((float)$item['item']->price), 2, '.', '')}} | {{$item['item']->qty}} unit(s)</p>
                </div>
            </div>
            <table>
                <tr>
            ...
            <table>
                <tr>
                    <div class="media-right">
                        <td>
                            <span class="">
                                <strong class="is-success" style="color: #1dca59;">-&#2547; {{number_format(((float)$discount_amount), 2, '.', '')}}</strong>
                            </span>
                        </td>
                    </div>
                </tr>
