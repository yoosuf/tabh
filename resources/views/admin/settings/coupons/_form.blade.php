    ...
    <div class="card-content">
        ...
        <div class="field">
            ...
            <div class="control is-expanded">
                <div class="control">
                    <label class="radio">
                        <input type="radio" name="reward_type"
                               value="fixed" {{ isset($item) && $item->reward_type == "fixed" || old('reward_type') == "fixed" ? "checked" : "" }} />
                        Fixed
                    </label>
                    <label class="radio">
                        <input type="radio" name="reward_type"
                               value="percent" {{ isset($item) && $item->reward_type == "percent" || old('reward_type') == "percent" ? "checked" : "" }} />
                        Percent
                    </label>
